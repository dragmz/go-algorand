...
const (
	GlobalMinTxnFee                 = logic.GlobalField(0)
	GlobalMinBalance                = logic.GlobalField(1)
	GlobalMaxTxnLife                = logic.GlobalField(2)
	GlobalZeroAddress               = logic.GlobalField(3)
	GlobalGroupSize                 = logic.GlobalField(4)
	GlobalLogicSigVersion           = logic.GlobalField(5)
	GlobalRound                     = logic.GlobalField(6)
	GlobalLatestTimestamp           = logic.GlobalField(7)
	GlobalCurrentApplicationID      = logic.GlobalField(8)
	GlobalCreatorAddress            = logic.GlobalField(9)
	GlobalCurrentApplicationAddress = logic.GlobalField(10)
	GlobalGroupID                   = logic.GlobalField(11)
	GlobalOpcodeBudget              = logic.GlobalField(12)
	GlobalCallerApplicationID       = logic.GlobalField(13)
	GlobalCallerApplicationAddress  = logic.GlobalField(14)
	GlobalAssetCreateMinbalance     = logic.GlobalField(15)
	GlobalAssetOptInMinBalance      = logic.GlobalField(16)
)

type GlobalExpr struct {
	Field logic.GlobalField
}
...
func Gtxns(f logic.TxnField) *GtxnsExpr {
...
func Txn(f logic.TxnField) *TxnExpr {
	return &TxnExpr{Field: f}
}

func Txna(f logic.TxnField, i uint8) *TxnaExpr {
...
func Arg(index uint8) *TxnaExpr {
	return Txna(logic.ApplicationArgs, index)
}

func ItxnField(field logic.TxnField) *ItxnFieldExpr {
...
func Global(index logic.GlobalField) *GlobalExpr {

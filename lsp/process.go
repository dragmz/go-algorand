...
type ProcessContext interface {
	...
	minVersion(v uint64)
	modeMinVersion(mode logic.RunMode, v uint64)

	mustReadDefine() string
	mustReadEcGroup(name string) logic.EcGroup
	mustReadBase64Encoding(name string) logic.Base64Encoding
	mustReadPragma(name string) uint64
	mustReadAddr(name string) string
	mustReadSignature(name string) string
	mustReadTxnField(name string) logic.TxnField
	mustReadItxnField(name string) logic.TxnField
	mustReadTxnaField(name string) logic.TxnField
	mustReadJsonRef(name string) logic.JSONRefType
	maybeReadUint8(name string) (uint8, bool)
	mustReadEcdsaCurveIndex(name string) logic.EcdsaCurve
	...
	mustReadGlobalField(name string) logic.GlobalField
	...
	mustReadAssetHoldingField(name string) logic.AssetHoldingField
	mustReadAssetParamsField(name string) logic.AssetParamsField
	mustReadAppParamsField(name string) logic.AppParamsField
	mustReadAcctParamsField(name string) logic.AcctParamsField
	mustReadBytes(name string) []byte
	mustReadVrfVerifyField(name string) logic.VrfStandard
	mustReadBlockField(name string) logic.BlockField
	mustReadVoterParamsField(name string) logic.VoterParamsField
	mustReadMimcField(name string) logic.MimcConfig
}
...
func (c *docContext) modeMinVersion(mode logic.RunMode, v uint64) {
	switch mode {
	case logic.ModeSig:
		c.sigVersion = v
	case logic.ModeApp:
...
func (c *docContext) mustReadEcGroup(name string) (v logic.EcGroup) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadBase64Encoding(name string) (v logic.Base64Encoding) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadJsonRef(name string) (v logic.JSONRefType) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadItxnField(name string) (f logic.TxnField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadTxnaField(name string) (f logic.TxnField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadTxnField(name string) (f logic.TxnField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadEcdsaCurveIndex(name string) (v logic.EcdsaCurve) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadGlobalField(name string) (v logic.GlobalField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadAssetHoldingField(name string) (v logic.AssetHoldingField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadAssetParamsField(name string) (v logic.AssetParamsField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadAppParamsField(name string) (v logic.AppParamsField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadMimcField(name string) (v logic.MimcConfig) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadVoterParamsField(name string) (v logic.VoterParamsField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadAcctParamsField(name string) (v logic.AcctParamsField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadVrfVerifyField(name string) (v logic.VrfStandard) {
	c.arg(opItemArg{
		Name: name,
...
func (c *docContext) mustReadBlockField(name string) (v logic.BlockField) {
	c.arg(opItemArg{
		Name: name,
...
func (c *parserContext) modeMinVersion(mode logic.RunMode, v uint64) {
}
...
func (c *parserContext) mustReadMimcField(name string) logic.MimcConfig {
	c.mustReadArg(name)
...
func (c *parserContext) mustReadVoterParamsField(name string) logic.VoterParamsField {
	c.mustReadArg(name)
...
func (c *parserContext) mustReadAcctParamsField(name string) logic.AcctParamsField {
	c.mustReadArg(name)
...
func (c *parserContext) mustReadAssetHoldingField(name string) logic.AssetHoldingField {
	c.mustReadArg(name)
...
func (c *parserContext) mustReadAssetParamsField(name string) logic.AssetParamsField {
	c.mustReadArg(name)
...
func (c *parserContext) mustReadBlockField(name string) logic.BlockField {
	c.mustReadArg(name)
...
func (c *parserContext) mustReadGlobalField(name string) logic.GlobalField {
	c.mustReadArg(name)
...
func (c *parserContext) mustReadVrfVerifyField(name string) logic.VrfStandard {
	c.mustReadArg(name)
...
func (c *parserContext) mustReadAppParamsField(name string) logic.AppParamsField {
	c.mustReadArg(name)
...
func (c *parserContext) parseEcGroup(name string) logic.EcGroup {
...
func (c *parserContext) parseBase64Encoding(name string) logic.Base64Encoding {
...
func (c *parserContext) parseJsonRef(name string) logic.JSONRefType {
...
func (c *parserContext) parseTxnField(tc fieldContext, name string) logic.TxnField {
...
func (c *parserContext) parseBytes(name string) []byte {
	...
	if strings.HasPrefix(arg, "base32(") || strings.HasPrefix(arg, "b32(") {
		...
		val, err := logic.Base32DecodeAnyPadding(arg[open+1 : close])
		if err != nil {
			c.failCurr(err)
		}
	...
	if arg == "base32" || arg == "b32" {
		...
		val, err := logic.Base32DecodeAnyPadding(l)
		if err != nil {
			c.failCurr(err)
		}
	...
	if len(arg) > 1 && arg[0] == '"' && arg[len(arg)-1] == '"' {
		val, err := logic.ParseStringLiteral(arg)
		if err != nil {
			c.failCurr(err)
		}
		c.strs = append(c.strs, c.args.Curr())
...
func (c *parserContext) parseEcdsaCurveIndex(name string) logic.EcdsaCurve {
...
func (c *parserContext) mustReadTxnField(name string) logic.TxnField {
	c.mustReadArg(name)
	return c.parseTxnField(txnFieldContext, name)
}

func (c *parserContext) mustReadItxnField(name string) logic.TxnField {
	c.mustReadArg(name)
	return c.parseTxnField(itxnFieldContext, name)
}

func (c *parserContext) mustReadTxnaField(name string) logic.TxnField {
	c.mustReadArg(name)
	return c.parseTxnField(txnaFieldContext, name)
}

func (c *parserContext) mustReadEcGroup(name string) logic.EcGroup {
	c.mustReadArg(name)
	return c.parseEcGroup(name)
}

func (c *parserContext) mustReadBase64Encoding(name string) logic.Base64Encoding {
	c.mustReadArg(name)
	return c.parseBase64Encoding(name)
}

func (c *parserContext) mustReadJsonRef(name string) logic.JSONRefType {
	c.mustReadArg(name)
	return c.parseJsonRef(name)
}

func (c *parserContext) mustReadEcdsaCurveIndex(name string) logic.EcdsaCurve {
	c.mustReadArg(name)
...
func opEd25519Verify(c ProcessContext) {
	c.modeMinVersion(logic.ModeSig, 1)
	c.modeMinVersion(logic.ModeApp, 5)
...
func opArg(c ProcessContext) {
	c.modeMinVersion(logic.ModeSig, 1)
	c.modeMinVersion(logic.ModeApp, 0)
	value := c.mustReadUint8("index")
...
func opGload(c ProcessContext) {
	c.modeMinVersion(logic.ModeSig, 0)
	c.modeMinVersion(logic.ModeApp, 4)
...
func opBalance(c ProcessContext) {
	c.modeMinVersion(logic.ModeSig, 0)
	c.modeMinVersion(logic.ModeApp, 2)
...
func opMinBalance(c ProcessContext) {
	c.modeMinVersion(logic.ModeSig, 0)
	c.modeMinVersion(logic.ModeApp, 3)
	c.emit(MinBalanceOp)
}
...
func opBoxCreate(c ProcessContext) {
	c.modeMinVersion(logic.ModeSig, 0)
	c.modeMinVersion(logic.ModeApp, 8)
	c.emit(BoxCreate)
}
...
func opBoxSplice(c ProcessContext) {
	c.modeMinVersion(logic.ModeSig, 0)
	c.modeMinVersion(logic.ModeApp, 10)
	c.emit(BoxSplice)
}
...
func opArgs(c ProcessContext) {
	c.modeMinVersion(logic.ModeSig, 5)
	c.modeMinVersion(logic.ModeApp, 0)
				...
				if ok {
					...
					if idx < len(info.Args) {
						...
						case OpArgTypeTxnaField:
							...
							if err == nil {
								spec, ok = logic.TxnFieldSpecByField(logic.TxnField(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeAcctParamsField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.AcctParamsFieldSpecByField(logic.AcctParamsField(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						case OpArgTypeAppParamsField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.AppParamsFieldSpecByField(logic.AppParamsField(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeVoterParamsField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.VoterParamsFieldSpecByField(logic.VoterParamsField(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeMimcField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.MimcConfigSpecByField(logic.MimcConfig(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeAssetHoldingField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.AssetHoldingFieldSpecByField(logic.AssetHoldingField(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeAssetParamsField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.AssetParamsFieldSpecByField(logic.AssetParamsField(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeBase64EncodingField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.Base64EncodingSpecByField(logic.Base64Encoding(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeBlockField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.BlockFieldSpecByField(logic.BlockField(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeEcdsaCurve:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.EcdsaCurveSpecByField(logic.EcdsaCurve(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeGlobalField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.GlobalFieldSpecByField(logic.GlobalField(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeJSONRefField:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.JsonRefSpecByField(logic.JSONRefType(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
						...
						case OpArgTypeVrfStandard:
							...
							v, err := strconv.Atoi(tok.String())
							if err == nil {
								spec, ok = logic.VrfStandardSpecByField(logic.VrfStandard(v))
								if ok {
									return fmt.Sprintf("%s = %d\r\n%s", spec.FieldString(), spec.Field(), spec.Note())
								}
							}
